...
(function configureEvergage() {
    try {
       Evergage.configure({
           account: "mscindustrialdirect",
           dataset: "marketing_prod",
           cdnUrl: "https://cdn.evergage.com",
           trackerUrl: "https://mscindustrialdirect.us-5.evergage.com",
           siteConfigVersion: "16"
       },{"allowBotTraffic":false,"corsAllowedOrigins":["*"],"defaultCurrency":"USD","defaultLocale":null,"disableQtipWindowScroll":false,"doNotStoreCookiesRequireProvidedAnonId":false,"doNotTrackPingRequestsForActions":false,"enableCorsRestrictedOrigins":false,"enableCrossDomainIframeCookies":false,"enableMessageRotation":false,"enableRememberMeUserIds":false,"enableTemplateEsc":false,"hideContentSections":false,"hideContentSectionsMillis":2500,"hidePagesForRedirect":false,"hidePagesForRedirectMillis":1000,"identityAttributes":["customerId","emailAddress","profileId","sfmcContactKey"],"lastModified":1712043170473,"preventSensitiveDataCapture":false,"rememberMeUserIdsMillis":63072000000,"secureCookie":true,"sendErrorEvents":true,"showPoweredBy":false,"siteConfigExecBeforePageReady":false,"spaRouteChangeTimeout":500,"trackAnonymousVisitors":true,"trackContextualRelatedItems":false,"trackSubdomainAsCompany":false,"trackUnknownPagesByTitle":false,"treatHashChangeAsPageLoad":false}       );
    } catch (e) {
          console.error(e);
    }
})();
...
Evergage.init({
    cookieDomain: "www.mscdirect.com",
    trackerUrl: "https://mscindustrialdirect.us-5.evergage.com"
}).then(() => {
    ...
    const config = {
        global: {
            onActionEvent: (actionEvent) => {
                // console.log("MCP_logs => v6");
                actionEvent.user = actionEvent.user || {};
                actionEvent.user.attributes = actionEvent.user.attributes || {};
                if (utag_data.customer_email != null) {
                    actionEvent.user.attributes.emailAddress = utag_data.customer_email;
                }
                if (utag_data.customer_id != null) {
                    actionEvent.user.attributes.as400id = utag_data.customer_id;
                }
                if (utag_data.cart_id != null) {
                    actionEvent.user.attributes.cartid = utag_data.cart_id;
                }
                if (utag_data.bill_to_id != null) {
                    actionEvent.user.attributes.billtoid = utag_data.bill_to_id;
                }
                if (utag_data.ship_to_id != null) {
                    actionEvent.user.attributes.shiptoid = utag_data.ship_to_id;
                }   
                return actionEvent; 
            },
              listeners: [
              // Evergage.listener("click", ".fotter-border .flex .flex div a", () => {
              //   // console.log("MCP_logs => Footer");    
              // }),                
              //   Evergage.listener("new_subscriber", document, (event) => {
        ...
        pageTypes: [
            {
                ...
                action: "ViewHome",
                isMatch: () => {
                                return utag_data.page_type === "home";
                            },
                contentZones: []                
            },
            {
                ...
                action: "Search",
                isMatch: () => {
                    return utag_data.page_type === "search results:xcr";  // Check if page_type matches "search results:xcr"
                },
                contentZones: []  // You can define content zones here if needed
            },
            {
                name: "Login",
                action: "ViewLogin",
                isMatch: () => {
                                return (utag_data.page_type === "my account:login") && !(/\?forward=ui\/cart/.test(window.location.href));
                            },
                contentZones: []
            },
            {
                name: "Checkout Login",
                action: "ViewCheckoutLogin",
                isMatch: () => {
                                return (utag_data.page_type === "my account:login") && (/\?forward=ui\/cart/.test(window.location.href));
                            },
                contentZones: []
            },            
            {
                ...
                action: "ViewAccount",
                isMatch: () => {
                                return utag_data.page_type === "my account:landing";
                            },
                contentZones: []
            },
            {
                ...
                action: "ViewBrand",
                isMatch: () => {
                                return utag_data.page_type === "content:industrial suppliers line card";
                            },
                contentZones: []
            },
            {
                name: "View Brand Category",
                action: "ViewBrandCategory",
                isMatch: () => /[?&](rdrct|intcmp)=/.test(window.location.href),
                contentZones: []
            },
            {
                name: "View Flyers",
                action: "ViewFlyers",
                isMatch: () => {
                                return utag_data.page_type === "flyer";
                            },
                contentZones: []
            },
            {
                name: "View Large Order Pad",
                action: "ViewLargeOrderPad",
                isMatch: () => {
                                return utag_data.page_type === "order pad";
                            },
                contentZones: []
            },
            {
                name: "View Checkout Shipping",
                action: "ViewCheckoutShipping",
                isMatch: () => {
                                return utag_data.page_type === "checkout:shipping";
                            },
                contentZones: []
            },
            {
                name: "View Checkout Payment",
                action: "ViewCheckoutPayment",
                isMatch: () => {
                                return utag_data.page_type === "checkout:payment";
                            },
                contentZones: []
            },
            {
                name: "View Checkout Review",
                action: "ViewCheckoutReview",
                isMatch: () => {
                                return utag_data.page_type === "checkout:review";
                            },
                contentZones: []
            },
            {
                ...
                action: "ViewForm",
                isMatch: () => {
                                return utag_data.page_type === "my account";
                            },
                contentZones: []
            },
            {
                name: "View Level 1 Category",
                action: "ViewLevel1Category",
                itemAction: Evergage.ItemAction.ViewCategory,   
                catalog: {
                      Category: {
                        _id: () => {
                            const catList = getPipeSeparatedCategoryList();
                            return catList;
                        },
                      },
                    },                             
                isMatch: () => {
                                return utag_data.page_type === "category:level 1";
                            },
                contentZones: []
            },
            {
                name: "View Level 2 Category",
                action: "ViewLevel2Category",
                itemAction: Evergage.ItemAction.ViewCategory,   
                catalog: {
                      Category: {
                        _id: () => {
                ...
                isMatch: () => {
                                return utag_data.page_type === "category:level 2";
                            },
                contentZones: []
            },                        
            {
                name: "View Level 3 Category",
                action: "ViewLevel3Category",
                itemAction: Evergage.ItemAction.ViewCategory,   
                catalog: {
                      Category: {
                        _id: () => {
                ...
                isMatch: () => {
                                return utag_data.page_type === "category:level 3";
                            },
                contentZones: []
            },
            {
                name: "View Level 4 Category",
                action: "ViewLevel4Category",
                itemAction: Evergage.ItemAction.ViewCategory,   
                catalog: {
                      Category: {
                        _id: () => {
                ...
                isMatch: () => {
                                return utag_data.page_type === "category:level 4";
                            },
                contentZones: []
            },
            {
                name: "View Level 5 Category",
                action: "ViewLevel5Category",
                itemAction: Evergage.ItemAction.ViewCategory,   
                catalog: {
                      Category: {
                        _id: () => {
                ...
                isMatch: () => {
                                return utag_data.page_type === "category:level 5";
                            },
                contentZones: []
            },            
            {
                name: "View Final Category",
                action: "ViewFinalCategory",
                itemAction: Evergage.ItemAction.ViewCategory,   
                catalog: {
                      Category: {
                        _id: () => {
                ...
                isMatch: () => {
                                return (utag_data.page_type === "category:terminal node" && utag_data.product_category.length >0 );
            ...
            },
            {
                ...
                isMatch: () => {
                                return (utag_data.page_type === "product detail" && utag_data.product_id[0] !== '');
                            },
                catalog: {
                    Product: {
                        _id: () => {                            
                        ...
                        starRating: () => {                            
                            if (!isNaN(parseFloat(utag_data.product_rating[0])))
                                return parseFloat(utag_data.product_rating[0]);
                            else
                                return 0;
                        },
                        numberOfReviews: () => {                            
                            return parseInt(utag_data.product_reviews[0]);
                        },                        
            ...
            },
            {
                ...
                action: "ViewCart",                
                isMatch: () => {
                                return utag_data.page_type === "shopping cart";
                            },
                ...
                catalog: {
                    Product: {
                        lineItems: {
                            _id: () => {
                                const ecommObj = getEcommCartObj();
                                // console.log("MCP_logs => ecommObj = " + ecommObj);
                                return ecommObj.productIDArray;
                            },
                            price: () => {
                                const ecommObj = getEcommCartObj();
                                // console.log("MCP_logs => ecommObj = " + ecommObj);
                                return ecommObj.productPriceArray;
                            },
                            quantity: () => {
                                const ecommObj = getEcommCartObj();
                                // console.log("MCP_logs => ecommObj = " + ecommObj);
                                return ecommObj.productQtyArray;
                            }
                        }
                    }
                }
            },            
            {
                ...
                action: "ViewOrderConfirmation",                
                isMatch: () => /\/checkout\/ordersummary\?orderId=/.test(window.location.href),
                itemAction: Evergage.ItemAction.Purchase,
                catalog: {
                    Product: {
                        orderId: () => {
                                const ecommObj = getEcommTYObj();
                                return ecommObj.orderId;
                            },
                        lineItems: {
                            _id: () => {
                                const ecommObj = getEcommTYObj();
...
// This is a helper function to get pipe separated category list
    const getPipeSeparatedCategoryList = () => {
        var categoryList = utag_data.product_category;
        var pipeSeparatedCatList = "";
        for (let i = 0; i < categoryList.length; i++) {
            pipeSeparatedCatList = pipeSeparatedCatList + "|" + categoryList[i];
        }
        if (pipeSeparatedCatList != "") {
            pipeSeparatedCatList = pipeSeparatedCatList.substring(1);
        }
        return pipeSeparatedCatList;
    }
// This is a helper function to get Product ID, Price and Qty on Cart Page
    const getEcommCartObj = () => {        
        // console.log("MCP_logs => Inside FUNC getEcommCartObj");
        var ecommObj = {};
        ecommObj.productIDArray = [];
        ecommObj.productPriceArray = [];
        ecommObj.productQtyArray = [];

        if (window.dataLayer) {
            // console.log("MCP_logs => Inside FUNC getEcommCartObj dataLayer.length = " + window.dataLayer.length);    
            for (let i = 0; i < window.dataLayer.length; i++) {
                // console.log("MCP_logs => Inside FUNC getEcommCartObj i = " + i);
                var currentDatalayerObject = window.dataLayer[i];
                // console.log("MCP_logs => Inside FUNC getEcommCartObj currentDatalayerObject event = " + currentDatalayerObject[1]);
                if (currentDatalayerObject != undefined && currentDatalayerObject[1] != undefined && currentDatalayerObject[1] == "view_cart" ) {
                    // console.log("MCP_logs => Inside FUNC getEcommCartObj view_cart FOUND");
                    var itemList = currentDatalayerObject[2].items;    
                    for (var j=0; j< itemList.length;j++){
                        ecommObj.productIDArray.push(itemList[j].item_id);
                        ecommObj.productPriceArray.push("$" + itemList[j].price);
                        ecommObj.productQtyArray.push(String(parseInt(itemList[j].quantity)));
                    }
                    // console.log("MCP_logs => FUNC returning ecommObj = " + ecommObj);
                    return ecommObj;
                }
            }
        }
...
// This is a helper function to get Product ID, Price and Qty on TY Page
    const getEcommTYObj = () => {        
        var ecommObj = {};
        ecommObj.productIDArray = [];
        ecommObj.productPriceArray = [];
        ...
        if (window.dataLayer) {
            for (let i = 0; i < window.dataLayer.length; i++) {
                var currentDatalayerObject = window.dataLayer[i];
                if (currentDatalayerObject != undefined && currentDatalayerObject[1] != undefined && currentDatalayerObject[1] == "purchase" && currentDatalayerObject[2]["event_category"] == undefined  && currentDatalayerObject[2]["allow_custom_scripts"] == undefined ) {
                    var itemList = currentDatalayerObject[2].items;    
                    for (var j=0; j< itemList.length;j++){
                        ecommObj.productIDArray.push(itemList[j].item_id);
                        ecommObj.productPriceArray.push("$" + itemList[j].price);
                    ...
                    ecommObj.orderId = currentDatalayerObject[2].transaction_id;
                    return ecommObj;
                }
            }
        }
...
var lastDatalayerIndexChecked = 0;

function fireEmailSignupFooterEvent(dataLayerObject) {
    Evergage.sendEvent({ action:"Footer Sign Up"});
}

function fireAddToMyListEvent(dataLayerObject) {
    Evergage.sendEvent({ action:"Add to List"});
}


function fireRemoveFromCartEvent_old(dataLayerObject) {
    Evergage.sendEvent({ action:"Remove Item"});
}

function fireAddToCartEvent(dataLayerObject) {
    var prodObj = {};
    prodObj._id = dataLayerObject[2].items[0].item_id;
     prodObj.price = 0;
    if (dataLayerObject[2].items[0].price != "undefined") {
        prodObj.price = parseFloat(dataLayerObject[2].items[0].price);
    }
    prodObj.quantity = parseInt(dataLayerObject[2].items[0].quantity);
    const lineItem = prodObj;
    lineItem.sku = { _id: lineItem._id };
    if (lineItem && lineItem._id && lineItem.price && lineItem.quantity && lineItem.sku && lineItem.sku._id) {
...
function fireRemoveFromCartEvent(dataLayerObject) {
    var prodObj = {};
    prodObj._id = dataLayerObject[2].items[0].item_id;
    if (dataLayerObject[2].items[0].price != undefined) {
        prodObj.price = parseFloat(dataLayerObject[2].items[0].price);
...
function fireEvent_login(dataLayerObject) {
    Evergage.sendEvent({ action:"LoginSuccess"});
}

function fireEvent_sign_up(dataLayerObject) {
    Evergage.sendEvent({ action:"RegistrationSuccess"});
}

function fireEvent_feedback_click(dataLayerObject) {
    Evergage.sendEvent({ action:"FeedbackSuccess"});
}


pushHandler(dataLayer, function(updatedDatalayer) {
   var datalayerCurrentLength = updatedDatalayer.length;
   
   for (var i = lastDatalayerIndexChecked; i < datalayerCurrentLength; i++) {        
        lastDatalayerIndexChecked++;
        var currentDatalayerObject = updatedDatalayer[i];
        
        if (currentDatalayerObject != undefined && currentDatalayerObject[1] != undefined && currentDatalayerObject[1] == "add_to_cart" && currentDatalayerObject[2]["event_category"] == undefined ) {
            fireAddToCartEvent(currentDatalayerObject);
        }

        if (currentDatalayerObject != undefined && currentDatalayerObject[1] != undefined && currentDatalayerObject[1] == "email_list_signup") {
            fireEmailSignupFooterEvent(currentDatalayerObject);
        }

        if (currentDatalayerObject != undefined && currentDatalayerObject[1] != undefined && currentDatalayerObject[1] == "add_to_wishlist") {
            fireAddToMyListEvent(currentDatalayerObject);
        }

        if (currentDatalayerObject != undefined && currentDatalayerObject[1] != undefined && currentDatalayerObject[1] == "remove_from_cart" && currentDatalayerObject[2]["event_category"] == undefined ) {
            fireRemoveFromCartEvent(currentDatalayerObject);
        }
        
        if (currentDatalayerObject != undefined && currentDatalayerObject[1] != undefined && currentDatalayerObject[1] == "login") {
            fireEvent_login(currentDatalayerObject);
        }

        if (currentDatalayerObject != undefined && currentDatalayerObject[1] != undefined && currentDatalayerObject[1] == "sign_up") {
            fireEvent_sign_up(currentDatalayerObject);
        }

        if (currentDatalayerObject != undefined && currentDatalayerObject[1] != undefined && currentDatalayerObject[1] == "feedback_click") {
            fireEvent_feedback_click(currentDatalayerObject);
        }
